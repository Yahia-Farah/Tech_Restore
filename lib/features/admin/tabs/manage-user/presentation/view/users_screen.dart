...
class _UsersScreenState extends State<UsersScreen> {
      ...
      body: BlocConsumer<GetUsersCubit, GetUsersState>(
        ...
        builder: (context, state) {
          ...
          if (state is GetUsersLoaded) {
            ...
            final activeUsers =
                users.where((user) => user.activate == true).length;
            final inactiveUsers =
                users.where((user) => user.activate == false).length;
  ...
  Widget _buildUserRow(UserModel user, AppLocalizations local) {
    ...
    final hasRoleChanged =
        _selectedRoles.containsKey(userId) &&
        _selectedRoles[userId] != originalRole;
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          SizedBox(
            width: 150,
            child: Text(fullName.isEmpty ? 'N/A' : fullName),
          ),
          // Email Column
          SizedBox(
            width: 220,
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    final success = await context
                        .read<GetUsersCubit>()
                        .toggleUserStatus(userId, user.activate ?? false);
                    if (success) {
                      ToastHelper.showCustomToast(
                        context,
                        text:
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    foregroundColor:
                        user.activate == false ? Colors.green : Colors.purple,
                    padding: const EdgeInsets.symmetric(
                      horizontal: 12,
                      vertical: 6,
                    ),
          ...
          ...List.generate(totalPages, (index) {
            ...
            return Padding(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      isCurrentPage ? AppColors.primary : Colors.grey.shade200,
                  foregroundColor:
