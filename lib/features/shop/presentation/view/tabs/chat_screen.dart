...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget _buildAvatar(String? name, bool isShop) {
    return CircleAvatar(
      radius: 20,
      backgroundColor: isShop ? const Color(0xFFDCFFD6) : const Color(0xFFE8F5E9),
      child: Text(
        _getInitials(name),
        style: TextStyle(
  ...
  Widget _buildMessageBubble(ChatMessageModel message, bool isShop, Locale locale) {
    return Padding(
          ...
          Flexible(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: isShop
                    ? null
                    : Border.all(color: const Color(0xFFDCFFD6), width: 1.5),
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            Padding(
              padding: EdgeInsets.only(right: isRTL ? 16 : 0, left: isRTL ? 0 : 16),
              child: Row(
              ...
              child: BlocBuilder<ShopChatCubit, ShopChatState>(
                builder: (context, state) {
                  ...
                  if (state is ShopChatError || state is ShopChatActionError) {
                    final errorKey = state is ShopChatError
                        ? state.msg
                  ...
                  if (state is ShopChatActionSuccess) {
                    ...
                    final successMsg = _getLocalizedMessage(state.message, local);
                    return Center(
                      child: Text(
                        successMsg,
                ...
                children: isRTL ? [
                  Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        onTap: _isWebSocketConnected ? _sendMessage : null,
                        borderRadius: BorderRadius.circular(12),
                        child: Padding(
