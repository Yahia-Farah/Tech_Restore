...
class _ApiClient implements ApiClient {
  ...
  Future<SignUpShopResponseModel> signUpShop(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<SignUpShopResponseModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'auth/register/shop',
  ...
  Future<ShopListResponse> getShops() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ShopListResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'admin/shops',
  ...
  Future<AdminStatesResponse> getAdminStats() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminStatesResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'admin/stats',
  ...
  Future<GetAllOffersModel> getOffers(int page) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetAllOffersModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'shop/offers',
  ...
  Future<OfferResponse> addOffer(OfferRequest model) async {
    ...
    final _data = <String, dynamic>{};
    _data.addAll(model.toJson());
    final _options = _setStreamType<OfferResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'shop/offers',
  ...
  @override
  Future<OfferResponse> updateOffer(OfferRequest model, String offerId) async {
    final _extra = <String, dynamic>{'auth': true};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<GetAllCategoryModel> getAllCategory(int page) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetAllCategoryModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'admin/categories',
  ...
  Future<TotalElementsResponse> lowStockInInventory() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TotalElementsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<TransactionAdminModelResponse> getAllTransactionsAdmin(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TransactionAdminModelResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<DeliveryAdminResponse> getAllDeliveriesAdmin(int page) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<DeliveryAdminResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'admin/deliveries',
  ...
  Future<ContentDeliveryAdmin> getDeliveryAdminById(String deliveryId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ContentDeliveryAdmin>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
